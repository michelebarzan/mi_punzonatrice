...
function getEditableTable()
{
	...
	$.post("editableTableParametri/getTableColumns.php",
	{
		table
	},
	function(response, status)
	{
		if(status=="success")
		{
			...
			else
			{
				...
				$.post("editableTableParametri/getEditableTable.php",
				{
					JSONnoFilterColumns,
					JSONcolumns,
					JSONreadOnlyColumns,
...
function insertRecord(row,table,newIndex)
{
	...
	$.post("editableTableParametri/insertRecordEditableTable.php",
	{
		table,
...
function deleteRow(primaryKey,table,primaryKeyValue,index)
{
	...
	$.post("editableTableParametri/deleteRowEditableTable.php",
	{
		table,
		primaryKey,
		primaryKeyValue
...
function confirmUpdate(index,table,oldRowButtons,primaryKey,primaryKeyValue)
{
	...
	newGridSpinner("","buttonColumn"+index,"width:24px;margin:0","","");
	$.post("editableTableParametri/confirmUpdateEditableTable.php",
	{
		table,
		primaryKey,
		primaryKeyValue,
